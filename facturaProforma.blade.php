        ...
        <tr>
            <td align="left" style="width: 40%;">
                ...
                <pre>
					...
					Status: {{ $carrinho->fechado==1?'Pago':'PROFORMA'}}<br />Data : {{ $carrinho->fechado==1?$carrinho->data_compra:'0000-00-00'}}
				</pre>
            ...
            <td align="right" style="width: 40%;">
                ...
                <pre>
                    ...
                    {{ $internauta->pais }}
                    {{ $carrinho->fechado==1?'Forma pagamento:'.$tipo_pagamento[($carrinho->tipo_pagamento)-1]:'PROFORMA'}}
                </pre>
            </td>
        </tr>
